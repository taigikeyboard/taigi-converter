...
describe("toZhuyin", () => {
  ...
  it("ir vowel after ts (no palatalization)", () => strictEqual(toZhuyin("tsir7"), "\u3117\u31a8\u02eb"));
  it("ir vowel after s (no palatalization)", () => strictEqual(toZhuyin("sir7"), "\u3119\u31a8\u02eb"));
  it("ir vowel after tsh (no palatalization)", () => strictEqual(toZhuyin("tshir1"), "\u3118\u31a8 "));
  it("ir vowel after j (no palatalization)", () => strictEqual(toZhuyin("jir5"), "\u31a1\u31a8\u02ca"));
  it("ir family irinn after ts", () => strictEqual(toZhuyin("tsirinn5"), "\u3117\u31a8\u31aa\u02ca"));
  it("ir family irng after s", () => strictEqual(toZhuyin("sirng1"), "\u3119\u31a8\u31ad "));
  it("ir vowel after k unaffected", () => strictEqual(toZhuyin("kir1"), "\u310d\u31a8 "));
