...
export const BRAILLE_INITIALS = new Map([
  ["p", "⠏"], ["ph", "⠋"], ["m", "⠍"], ["b", "⠃"],
  ["t", "⠙"], ["th", "⠞"], ["n", "⠝"], ["l", "⠇"],
  ["k", "⠟"], ["kh", "⠅"], ["ng", "⠬"], ["g", "⠛"],
  ["ts", "⠡"], ["tsh", "⠉"], ["s", "⠎"], ["j", "⠚"],
...
export const BRAILLE_FINALS = new Map([
  ["a", "⠁"], ["i", "⠊"], ["u", "⠥"], ["e", "⠑"],
  ["o", "⠕"], ["oo", "⠪"], ["m", "⠍"], ["ng", "⠬"],
  ["ai", "⠜"], ["au", "⠳"], ["ia", "⠽"], ["io", "⠗"],
  ["iu", "⠱"], ["ua", "⠺"], ["ue", "⠫"], ["ui", "⠷"],
...
export const BRAILLE_TONES = new Map([
  ["1", "⠤"], ["2", "⠂"], ["3", "⠄"], ["4", "⠢"],
  ["5", "⠆"], ["6", "⠂"], ["7", "⠒"], ["8", "⠔"],
  ["9", "⠘"]
]);

export const BRAILLE_NASAL = "⠠";

export const BRAILLE_KHIN = "⠤⠤";

export const BRAILLE_PUNCTUATION = new Map([
  [",", "⠂⠀"], ["，", "⠂⠀"], ["、", "⠂⠀"],
  [".", "⠲⠀"], ["。", "⠲⠀"],
  ["?", "⠦⠀"], ["？", "⠦⠀"],
  ["!", "⠖⠀"], ["！", "⠖⠀"],
